...
ALTER TABLE alerts ADD CONSTRAINT fk_alerts_1 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE alerts ADD CONSTRAINT fk_alerts_2 FOREIGN KEY (rule_id) REFERENCES alert_rules (id);
ALTER TABLE alerts ADD CONSTRAINT fk_alerts_3 FOREIGN KEY (serial_id) REFERENCES serial_numbers (id);
ALTER TABLE alerts ADD CONSTRAINT fk_alerts_4 FOREIGN KEY (acknowledged_by_user_id) REFERENCES users (id);
ALTER TABLE alerts ADD CONSTRAINT fk_alerts_5 FOREIGN KEY (location_id) REFERENCES locations (id);
...
ALTER TABLE customers ADD CONSTRAINT fk_customers_1 FOREIGN KEY (segment_id) REFERENCES customer_segments (id);
ALTER TABLE customers ADD CONSTRAINT fk_customers_2 FOREIGN KEY (country_id) REFERENCES countries (id);
ALTER TABLE demand_signals ADD CONSTRAINT fk_demand_signals_1 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE demand_signals ADD CONSTRAINT fk_demand_signals_2 FOREIGN KEY (location_id) REFERENCES locations (id);
ALTER TABLE demand_signals ADD CONSTRAINT fk_demand_signals_3 FOREIGN KEY (created_by_user_id) REFERENCES users (id);
ALTER TABLE distribution_order_lines ADD CONSTRAINT fk_distribution_order_lines_1 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE distribution_order_lines ADD CONSTRAINT fk_distribution_order_lines_2 FOREIGN KEY (dist_order_id) REFERENCES distribution_orders (id);
...
ALTER TABLE distribution_orders ADD CONSTRAINT fk_distribution_orders_1 FOREIGN KEY (destination_location_id) REFERENCES locations (id);
ALTER TABLE distribution_orders ADD CONSTRAINT fk_distribution_orders_2 FOREIGN KEY (origin_location_id) REFERENCES locations (id);
...
ALTER TABLE distribution_received ADD CONSTRAINT fk_distribution_received_1 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE distribution_received ADD CONSTRAINT fk_distribution_received_2 FOREIGN KEY (dist_order_id) REFERENCES distribution_orders (id);
ALTER TABLE firmware ADD CONSTRAINT fk_firmware_1 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE flow_constraints ADD CONSTRAINT fk_flow_constraints_1 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE flow_constraints ADD CONSTRAINT fk_flow_constraints_2 FOREIGN KEY (flow_id) REFERENCES supply_flows (id);
ALTER TABLE goods_receipt_messages ADD CONSTRAINT fk_goods_receipt_messages_1 FOREIGN KEY (po_id) REFERENCES purchase_orders (id);
ALTER TABLE goods_receipt_messages ADD CONSTRAINT fk_goods_receipt_messages_2 FOREIGN KEY (created_by_user_id) REFERENCES users (id);
...
ALTER TABLE outbound_order_nonserial ADD CONSTRAINT fk_outbound_order_nonserial_1 FOREIGN KEY (order_line_id) REFERENCES outbound_order_lines (id);
ALTER TABLE outbound_order_nonserial ADD CONSTRAINT fk_outbound_order_nonserial_2 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE outbound_order_nonserial ADD CONSTRAINT fk_outbound_order_nonserial_3 FOREIGN KEY (order_id) REFERENCES outbound_orders (id);
...
ALTER TABLE repair_documents ADD CONSTRAINT fk_repair_documents_1 FOREIGN KEY (rr_order_id) REFERENCES repair_rework_orders (id);
ALTER TABLE repair_documents ADD CONSTRAINT fk_repair_documents_2 FOREIGN KEY (uploaded_by_user_id) REFERENCES users (id);
...
ALTER TABLE repair_orders ADD CONSTRAINT fk_repair_orders_2 FOREIGN KEY (return_order_id) REFERENCES return_orders (id);
ALTER TABLE repair_orders ADD CONSTRAINT fk_repair_orders_3 FOREIGN KEY (repair_centre_location_id) REFERENCES locations (id);
ALTER TABLE repair_orders ADD CONSTRAINT fk_repair_orders_4 FOREIGN KEY (return_location_id) REFERENCES locations (id);
...
ALTER TABLE repair_rework_serials ADD CONSTRAINT fk_repair_rework_serials_1 FOREIGN KEY (serial_id) REFERENCES serial_numbers (id);
ALTER TABLE repair_rework_serials ADD CONSTRAINT fk_repair_rework_serials_2 FOREIGN KEY (rr_order_id) REFERENCES repair_rework_orders (id);
...
ALTER TABLE safety_stock_targets ADD CONSTRAINT fk_safety_stock_targets_2 FOREIGN KEY (created_by_user_id) REFERENCES users (id);
ALTER TABLE safety_stock_targets ADD CONSTRAINT fk_safety_stock_targets_3 FOREIGN KEY (location_id) REFERENCES locations (id);
...
ALTER TABLE serial_numbers ADD CONSTRAINT fk_serial_numbers_1 FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE serial_numbers ADD CONSTRAINT fk_serial_numbers_2 FOREIGN KEY (current_state_id) REFERENCES terminal_states (id);
ALTER TABLE serial_numbers ADD CONSTRAINT fk_serial_numbers_3 FOREIGN KEY (current_location_id) REFERENCES locations (id);
ALTER TABLE serial_numbers ADD CONSTRAINT fk_serial_numbers_4 FOREIGN KEY (supplier_id) REFERENCES suppliers (id);
...
ALTER TABLE state_transitions ADD CONSTRAINT fk_state_transitions_1 FOREIGN KEY (to_state_id) REFERENCES terminal_states (id);
ALTER TABLE state_transitions ADD CONSTRAINT fk_state_transitions_2 FOREIGN KEY (from_state_id) REFERENCES terminal_states (id);
...
ALTER TABLE supply_flows ADD CONSTRAINT fk_supply_flows_2 FOREIGN KEY (to_supplier_id) REFERENCES suppliers (id);
