...
ALTER TABLE work_order_lines ADD CONSTRAINT fk_work_order_lines_4 FOREIGN KEY (work_order_id) REFERENCES work_orders (id);
ALTER TABLE work_orders ADD CONSTRAINT fk_work_orders_1 FOREIGN KEY (created_by_user_id) REFERENCES users (id);
ALTER TABLE work_orders ADD CONSTRAINT fk_work_orders_2 FOREIGN KEY (location_id) REFERENCES locations (id);
ALTER TABLE work_orders ADD CONSTRAINT fk_work_orders_3 FOREIGN KEY (outbound_order_id) REFERENCES outbound_orders (id);
